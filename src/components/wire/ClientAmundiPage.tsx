  ...
  return (
    <div className="wire-page">
      <div className="wire-shell wire-shell--wide">
        ...
        <div className="wire-kpis">
          {AMUNDI.kpis.map((k) => (
            <div key={k.label} className="wire-kpi">
        ...
        <div className="wire-client-grid">
          <DensePanel title={AMUNDI.matrixTitle}>
            ...
            <p className="wire-sub" style={{ marginTop: 8 }}>
              {AMUNDI.historyNote}
            </p>
          </DensePanel>
